...
function AlbumDetails() {
    ...
    useEffect(() => {
        const fetchAlbumPhotos = async () => {
            try {
                const response = serverRequests('GET', `photos?albumId=${albumId}&_page=${currentPage}&_limit=${photosPerPage}`, null)
                if (response.ok) {
                    ...
                    console.error('Failed to get album details:', response.statusText);
                }
